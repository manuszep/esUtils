        ...
        <div className="whatsapp__container"
          ...
          onClick={() => {
            this.props.showModal({
              "title": <T noprefix={true} >MODAL_HELP_TOOL_TITLE</T>,
              "body": <T noprefix={true} >MODAL_HELP_TOOL_BODY</T>,
              "closeLabel": <T noprefix={true} >MODAL_HELP_TOOL_CLOSE</T>
            });
          }
          }
        >
    ...
    return (
      <div className="header__tools">
        <span>
          ...
          <T className="needHelp-title">HELP_TITLE</T>
            ...
            <div className="button_container">
              ...
              >
                ...
                <T noprefix={true} className="needHelpText_mobile">WHATSAPP_BUTTON</T>
                <T noprefix={true} className="needHelpText_desktop">WHATSAPP_BUTTON_DESKTOP</T>
              </div>
            </div>
          </div>
        </span>
